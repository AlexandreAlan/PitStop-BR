...
<header class="header-dark">
    ...
    <div class="dropdown sair">
        ...
        <ul class="dropdown-menu dropdown-menu-end">
            ...
            <li><a class="dropdown-item" href="postos.php"><i class="bi bi-signpost me-2"></i>Meus Postos</a></li>
            <li><a class="dropdown-item" href="importar.php"><i class="bi bi-upload me-2"></i>Importar Histórico</a></li>
